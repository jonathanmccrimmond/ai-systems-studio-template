...
> Single Source of Truth (SSOT) for this project.
...
All meaningful changes must be reflected in:
1. `PROJECT_MASTER.md` (first)
2. `CHANGELOG.md`
3. Any affected downstream docs (`ROADMAP.md`, `ARCHITECTURE.md`, `slides/`, portfolio pages)

## 11. Agent Operations

- Agent Definitions: `agents/`
- Agent Activity Log: `AGENT_LOG.md`
- Escalation Rule: Agents propose; project owner approves strategic changes.
